...
const UploadPage = ({ loading, errors, setImageFile, submitImage }) => {
  ...
  return (
    <div>
      <div class="group grid grid-rows-5 grid-cols-1 items-center justify-center content-between w-full bg-screen bg-center h-screen bg-[url('/public/header_canvas.jpg')] ">
        <div></div>
        ...
        <div class="flex flex-col items-center justify-center w-full">
          <label for="dropzone-file" class="flex flex-col items-center justify-center h-1/2 w-1/2 border-2 border-gray-400 border-dashed rounded-lg cursor-pointer bg-transparent m-3">
